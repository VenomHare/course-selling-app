        ...
        <div className="w-screen h-screen flex flex-col items-center">
            ...
            <div className="flex flex-col items-center justify-center h-screen ">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <Link to={"/purchased"} className="flex flex-col items-center justify-center p-6 bg-slate-800 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 text-slate-200 hover:bg-slate-700 border border-slate-700 hover:scale-105">
                        <BookOpenText size={24} className="mb-2 text-purple-500" />
